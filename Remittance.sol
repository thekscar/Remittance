...
contract Remittance{
    ...
    //Stretch goals
    uint    public deadline; //Assume to use block numbers, does this mean a limit

function Remittance(address alice, address carol, address bob, uint noOBlocks)
// Not payable - avoid sending ether during deployment
//Should I assume that I input all addresses for Alice, Bob & Carol? 
//Should I assume that I choose the deadline or does Alice? 
{
    owner = msg.sender; 
    sendR = alice; 
    exchanger = carol; 
...
{
    //Tells you if blockchain is at the blocks before the deadline
